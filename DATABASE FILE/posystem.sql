...
CREATE TABLE `sales` (
  ...
  `payment_status` enum('Paid','Unpaid','Partial') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'Paid',
...
(9, 10001, 2, 2, '[{\"id\":\"25\",\"description\":\"Product Sample Two\",\"quantity\":\"3\",\"stock\":\"29\",\"price\":\"185\",\"totalPrice\":\"555\"}]', 17, 555, 572, 'cash', 'Paid', '2018-12-04 00:53:28'),
(11, 10002, 3, 1, '[{\"id\":\"44\",\"description\":\"Product Sample Four\",\"quantity\":\"4\",\"stock\":\"16\",\"price\":\"490\",\"totalPrice\":\"1960\"},{\"id\":\"36\",\"description\":\"Product Sample Three\",\"quantity\":\"6\",\"stock\":\"14\",\"price\":\"125\",\"totalPrice\":\"750\"}]', 0, 2710, 2710, 'cash', 'Paid', '2018-12-05 06:30:28'),
...
CREATE TABLE `payment_audit` (
  ...
  `old_status` enum('Paid','Unpaid','Partial') COLLATE utf8_spanish_ci NOT NULL,
  `new_status` enum('Paid','Unpaid','Partial') COLLATE utf8_spanish_ci NOT NULL,
  `changed_by` int(11) NOT NULL,
  `changed_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `remarks` text COLLATE utf8_spanish_ci,
  PRIMARY KEY (`id`),
  KEY `sale_id` (`sale_id`),
